...
(spc-leader
  ...
  "w w" '((lambda () (interactive) (persp-frame-switch "w")) :wk "w")
)
#+end_src
...
(require 'magit)
  ...
  ; (defun my-magit-toggle-evil-visual-line-mode ()
  ;   "Включает или выключает evil-visual-line-mode в режиме magit-mode."
  ;   (interactive)
  ;    (evil-visual-line))

  ; (define-key magit-mode-map (kbd "C-c v") #'my-magit-toggle-evil-visual-line-mode)
